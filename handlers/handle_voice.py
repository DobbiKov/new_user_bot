...
from modules.translate_voice import delete_files, translate_voice, convert_ogg_wav, translate_voice_texts, translate_voice_text
...
async def get_voice(client: Client, message: types.Message):
    ...
    text, lang = translate_voice(file_path)
    ...
    translated_text = translate_voice_text(text, lang)
